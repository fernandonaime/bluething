...
def check_xserver():
    result = os.system("dpkg -l | grep '^ii  xserver-xorg ' > /dev/null 2>&1")
    if result == 0:
        return True
    else:
        return False
...
def check_avahi():
    result = os.system("dpkg -l | grep '^ii  avahi-daemon ' > /dev/null 2>&1")
    if result == 0:
        return True
    else:
        return False
...
def check_dhcp():
    result = os.system("dpkg -l | grep '^ii  isc-dhcp-server ' > /dev/null 2>&1")
    if result == 0:
        return True
    else:
        return False
...
def check_ldap():
    result = os.system("dpkg -l | grep '^ii  slapd ' > /dev/null 2>&1")
    if result == 0:
        return True
    else:
        return False
...
def check_nfs():
    result = os.system("dpkg -l | grep '^ii  nfs-kernel-server ' > /dev/null 2>&1")
    if result == 0:
        return True
    else:
        return False
...
def check_vsftpd():
    result = os.system("dpkg -l | grep '^ii  vsftpd ' > /dev/null 2>&1")
    if result == 0:
        return True
    else:
        return False
...
def check_http():
    result = os.system("dpkg -l | grep '^ii  apache2 ' > /dev/null 2>&1")
    if result == 0:
        return True
    else:
        return False
...
def check_imap():
    result = os.system("dpkg -l | grep '^ii  dovecot-imapd ' > /dev/null 2>&1")
    if result == 0:
        return True
    else:
        return False
...
def check_pop3():
    result = os.system("dpkg -l | grep '^ii  dovecot-pop3d ' > /dev/null 2>&1")
    if result == 0:
        return True
    else:
        return False
...
def check_samba():
    result = os.system("dpkg -l | grep '^ii samba' > /dev/null 2>&1")
    if result == 0:
        return True
    else:
        return False
...
def check_squid():
    result = os.system("dpkg -l | grep '^ii  squid' > /dev/null 2>&1")
    if result == 0:
        return True
    else:
        return False
...
def check_snmp():
    result = os.system("dpkg -l | grep '^ii  snmpd ' > /dev/null 2>&1")
    if result == 0:
        return True
    else:
        return False
...
def check_dnsmasq():
    result = os.system("dpkg -l | grep '^ii  dnsmasq ' > /dev/null 2>&1")
    if result == 0:
        return True
    else:
        return False
...
def check_rsync():
    result = os.system("dpkg -l | grep '^ii  rsync ' > /dev/null 2>&1")
    if result == 0:
        return True
    else:
        return False
...
def check_cups():
    result = os.system("dpkg -l | grep '^ii  cups ' > /dev/null 2>&1")
    if result == 0:
        return True
    else:
        return False
...
def scan_imap():
    if check_imap():
        print(f"- IMAP is installed.\U000026D4  Please Uninstall it. \U000026D4 \n")
        line = "IMAP is installed.\U000026D4  Please Uninstall it. \U000026D4 \n"
        log_changes(line, "services")
    else:
        print("- IMAP is not installed. No action is needed.\n")
        line = "IMAP is not installed. No action is needed.\n"
        log_changes(line, "services")
def scan_pop3():
    if check_pop3():
        print(f"- POP3 is installed.\U000026D4  Please Uninstall it. \U000026D4 \n")
        line = "POP3 is installed.\U000026D4  Please Uninstall it. \U000026D4 \n"
        log_changes(line, "services")
    else:
        print("- POP3 is not installed. No action is needed.\n")
        line = "POP3 is not installed. No action is needed.\n"
        log_changes(line, "services")
...
def scan_cups():
    if check_cups():
        print(f"- CUPS is installed.\U000026D4  Please Uninstall it. \U000026D4 \n")
        line = "CUPS is installed.\U000026D4  Please Uninstall it. \U000026D4 \n"
        log_changes(line, "services")
    else:
        print("- CUPS is not installed. No action is needed.\n")
        line = "CUPS is not installed. No action is needed.\n"
        log_changes(line, "services")
...
def purge_xserver():
    if check_xserver():
        if ask("X Windows System"):
            print(f"Uninstallation of X-Server...\n")
            line = "Uninstallation of X-Server..."
            log_changes(line, "services")
            # os.system("systemctl stop gdm.service")
            # os.system("systemctl stop gdm3.service")
            # os.system("systemctl stop lightdm.service")
            # os.system("systemctl stop lightdm.service")
            # os.system("systemctl stop sddm.service")
            # os.system("systemctl stop xdm.service")
            os.system("apt purge xserver-xorg* > /dev/null 2>&1")
        else:
            print("X Windows System uninstallation bypassed.\n")
            line = "X Windows System uninstallation bypassed.\n"
            log_changes(line, "services")
    else:
        print("- X Windows System is not installed.\n")
        line = "X Windows System is not installed.\n"
        log_changes(line, "services")
...
def purge_avahi():
    if check_avahi():
        if ask("Avahi Server"):
            print(f"Uninstallation of Avahi-Server...\n")
            line = "Uninstallation of Avahi-Server..."
            log_changes(line, "services")
            os.system("systemctl stop avahi-daemon.service")
            os.system("systemctl stop avahi-daemon.socket")
            os.system("apt purge avahi-daemon > /dev/null 2>&1")
        else:
            print("Avahi Server uninstallation bypassed.\n")
            line = "Avahi Server uninstallation bypassed.\n"
            log_changes(line, "services")
    else:
        print("- Avahi Server is not installed.\n")
        line = "Avahi Server is not installed.\n"
        log_changes(line, "services")
...
def purge_dhcp():
    if check_dhcp():
        if ask("DHCP Server"):
            print(f"Uninstallation of DHCP-Server...\n")
            line = "Uninstallation of DHCP-Server..."
            log_changes(line, "services")
            os.system("systemctl stop isc-dhcp-server.service")
            os.system("systemctl stop isc-dhcp-server6.service")
            os.system("apt purge isc-dhcp-server > /dev/null 2>&1")
        else:
            print("DHCP Server uninstallation bypassed.\n")
            line = "DHCP Server uninstallation bypassed.\n"
            log_changes(line, "services")
    else:
        print("- DHCP Server is not installed.\n")
        line = "DHCP Server is not installed.\n"
        log_changes(line, "services")
...
def purge_ldap():
    if check_ldap():
        if ask("LDAP Server"):
            print(f"Uninstallation of LDAP-Server...\n")
            line = "Uninstallation of LDAP-Server..."
            log_changes(line, "services")
            os.system("systemctl stop slapd.service")
            os.system("apt purge slapd > /dev/null 2>&1")
        else:
            print("LDAP Server uninstallation bypassed.\n")
            line = "LDAP Server uninstallation bypassed.\n"
            log_changes(line, "services")
    else:
        print("- LDAP Server is not installed.\n")
        line = "LDAP Server is not installed.\n"
        log_changes(line, "services")
...
def purge_nfs():
    if check_nfs():
        if ask("NFS Server"):
            print(f"Uninstallation of NFS-Server...\n")
            line = "Uninstallation of NFS-Server..."
            log_changes(line, "services")
            os.system("systemctl stop nfs-server.service")
            os.system("systemctl stop nfs-mountd.service")
            os.system("systemctl stop nfs-idmapd.service")
            os.system("systemctl stop nfs-idmapd.socket")
            os.system("apt purge nfs-kernel-server > /dev/null 2>&1")
        else:
            print("NFS Server uninstallation bypassed.\n")
            line = "NFS Server uninstallation bypassed.\n"
            log_changes(line, "services")
    else:
        print("- NFS Server is not installed.\n")
        line = "NFS Server is not installed.\n"
        log_changes(line, "services")
...
def purge_dns():
    if check_dns():
        if ask("DNS Server"):
            print(f"Uninstallation of DNS-Server...\n")
            line = "Uninstallation of DNS-Server..."
            log_changes(line, "services")
            os.system("systemctl stop bind9.service")
            os.system("apt purge bind9 > /dev/null 2>&1")
        else:
            print("DNS Server uninstallation bypassed.\n")
            line = "DNS Server uninstallation bypassed.\n"
            log_changes(line, "services")
    else:
        print("- DNS Server is not installed.\n")
        line = "DNS Server is not installed.\n"
        log_changes(line, "services")
...
def purge_vsftpd():
    if check_vsftpd():
        if ask("FTP Server"):
            print(f"Uninstallation of FTP-Server...\n")
            line = "Uninstallation of FTP-Server..."
            log_changes(line, "services")
            os.system("systemctl stop vsftpd.service")
            os.system("apt purge vsftpd > /dev/null 2>&1")
        else:
            print("FTP Server uninstallation bypassed.\n")
            line = "FTP Server uninstallation bypassed.\n"
            log_changes(line, "services")
    else:
        print("- FTP Server is not installed.\n")
        line = "FTP Server is not installed.\n"
        log_changes(line, "services")
...
def purge_http():
    if check_http():
        if ask("HTTP Server"):
            print(f"Uninstallation of HTTP-Server...\n")
            line = "Uninstallation of HTTP-Server..."
            log_changes(line, "services")
            os.system("systemctl stop apache2.service")
            os.system("apt purge apache2 > /dev/null 2>&1")
        else:
            print("HTTP Server uninstallation bypassed.\n")
            line = "HTTP Server uninstallation bypassed.\n"
            log_changes(line, "services")
    else:
        print("- HTTP Server is not installed.\n")
        line = "HTTP Server is not installed.\n"
        log_changes(line, "services")
...
def purge_imap():
    if check_imap():
        if ask("IMAP"):
            print(f"- IMAP is installed.{Fore.RED} Proceeding to uninstall...{Style.RESET_ALL}\n")
            line = "IMAP is installed.{Fore.RED} Proceeding to uninstall...{Style.RESET_ALL}\n"
            log_changes(line, "services")
            os.system("apt purge dovecot-impad")
        else:
            print("IMAP was not removed due to user input.\n")
            line = "IMAP was not removed due to user input.\n"
            log_changes(line, "services")
    else:
        print("- IMAP is not installed. No action needed.\n")
        line = "IMAP is not installed. No action needed.\n"
        log_changes(line, "services")

def purge_pop3():
    if check_pop3():
        if ask("POP3"):
            print(f"- POP3 is installed.{Fore.RED} Proceeding to uninstall...{Style.RESET_ALL}\n")
            line = "POP3 is installed.{Fore.RED} Proceeding to uninstall...{Style.RESET_ALL}\n"
            log_changes(line, "services")
            os.system("apt purge dovecot-pop3d")
        else:
            print("POP3 was not removed due to user input.\n")
            line = "POP3 was not removed due to user input.\n"
            log_changes(line, "services")
    else:
        print("- POP3 is not installed. No action needed.\n")
        line = "POP3 is not installed. No action needed.\n"
        log_changes(line, "services")
...
def purge_samba():
    if check_samba():
        if ask("Samba Server"):
            print(f"Uninstallation of Samba-Server...\n")
            line = "Uninstallation of Samba-Server..."
            log_changes(line, "services")
            os.system("systemctl stop smbd.service")
            os.system("systemctl stop nmbd.service")
            os.system("apt purge samba > /dev/null 2>&1")
        else:
            print("Samba Server uninstallation bypassed.\n")
            line = "Samba Server uninstallation bypassed.\n"
            log_changes(line, "services")
    else:
        print("- Samba Server is not installed.\n")
        line = "Samba Server is not installed.\n"
        log_changes(line, "services")
...
def purge_squid():
    if check_squid():
        if ask("HTTP Proxy Server"):
            print(f"Uninstallation of HTTP Proxy Server...\n")
            line = "Uninstallation of HTTP Proxy Server..."
            log_changes(line, "services")
            os.system("systemctl stop squid.service")
            os.system("apt purge squid > /dev/null 2>&1")
        else:
            print("HTTP Proxy Server uninstallation bypassed.\n")
            line = "HTTP Proxy Server uninstallation bypassed.\n"
            log_changes(line, "services")
    else:
        print("- HTTP Proxy Server is not installed.\n")
        line = "HTTP Proxy Server is not installed.\n"
        log_changes(line, "services")
...
def purge_snmp():
    if check_snmp():
        if ask("SNMP Server"):
            print(f"Uninstallation of SNMP Server...\n")
            line = "Uninstallation of SNMP Server..."
            log_changes(line, "services")
            os.system("systemctl stop snmpd.service")
            os.system("apt purge snmpd > /dev/null 2>&1")
        else:
            print("SNMP Server uninstallation bypassed.\n")
            line = "SNMP Server uninstallation bypassed.\n"
            log_changes(line, "services")
    else:
        print("- SNMP Server is not installed.\n")
        line = "SNMP Server is not installed.\n"
        log_changes(line, "services")
...
def purge_nis():
    if check_nis():
        if ask("NIS Server"):
            print(f"Uninstallation of NIS Server...\n")
            line = "Uninstallation of NIS Server..."
            log_changes(line, "services")
            os.system("systemctl stop nis.service")
            os.system("apt purge nis > /dev/null 2>&1")
        else:
            print("NIS Server uninstallation bypassed.\n")
            line = "NIS Server uninstallation bypassed.\n"
            log_changes(line, "services")
    else:
        print("- NIS Server is not installed.\n")
        line = "NIS Server is not installed.\n"
        log_changes(line, "services")
...
def purge_dnsmasq():
    if check_dnsmasq():
        if ask("DNSMASQ"):
            print(f"Uninstallation of DNSMASQ...\n")
            line = "Uninstallation of DNSMASQ..."
            log_changes(line, "services")
            os.system("systemctl stop dnsmasq.service")
            os.system("apt purge dnsmasq-base > /dev/null 2>&1")
        else:
            print("DNSMASQ uninstallation bypassed.\n")
            line = "DNSMASQ uninstallation bypassed.\n"
            log_changes(line, "services")
    else:
        print("- DNSMASQ is not installed.\n")
        line = "DNSMASQ is not installed.\n"
        log_changes(line, "services")
...
def purge_rsync():
    if check_rsync():
        if ask("Rsync"):
            print(f"Uninstallation of Rsync...\n")
            line = "Uninstallation of Rsync..."
            log_changes(line, "services")
            os.system("systemctl stop rsync.service")
            os.system("apt purge rsync > /dev/null 2>&1")
        else:
            print("Rsync uninstallation bypassed.\n")
            line = "Rsync uninstallation bypassed.\n"
            log_changes(line, "services")
    else:
        print("- Rsync is not installed.\n")
        line = "Rsync is not installed.\n"
        log_changes(line, "services")
...
def purge_rsh():
    if check_rsh():
        if ask("Rsh Client"):
            print(f"\033[91mUninstallation of RSH-Client...\033[0m")
            line = "\033[91mUninstallation of RSH-Client...\033[0m"
            log_changes(line, "services")
            os.system("apt purge rsh-client > /dev/null 2>&1")
        else:
            print("Rsh Client uninstallation bypassed")
            line = "Rsh Client uninstallation bypassed"
            log_changes(line, "services")
    else:
        print("Rsh Client is not installed")
        line = "Rsh Client is not installed"
        log_changes(line, "services")
...
def purge_talk():
    if check_talk():
        if ask("Talk Client"):
            print(f"\033[91mUninstallation of Talk-Client...\033[0m")
            line = "\033[91mUninstallation of Talk-Client...\033[0m"
            log_changes(line, "services")
            os.system("apt purge talk > /dev/null 2>&1")
        else:
            print("Talk Client uninstallation bypassed")
            line = "Talk Client uninstallation bypassed"
            log_changes(line, "services")
    else:
        print("Talk Client is not installed")
        line = "Talk Client is not installed"
        log_changes(line, "services")
...
def purge_telnet():
    if check_telnet():
        if ask("Telnet Client"):
            print(f"\033[91mUninstallation of Telnet-Client...\033[0m")
            line = "\033[91mUninstallation of Telnet-Client...\033[0m"
            log_changes(line, "services")
            os.system("apt purge telnet > /dev/null 2>&1")
        else:
            print("Telnet Client uninstallation bypassed")
            line = "Telnet Client uninstallation bypassed"
            log_changes(line, "services")
    else:
        print("Telnet Client is not installed")
        line = "Telnet Client is not installed"
        log_changes(line, "services")
...
def purge_ldap_utils():
    if check_ldap_utils():
        if ask("LDAP Client"):
            print(f"\033[91mUninstallation of LDAP-Client...\033[0m")
            line = "\033[91mUninstallation of LDAP-Client...\033[0m"
            log_changes(line, "services")
            os.system("apt purge ldap-utils > /dev/null 2>&1")
        else:
            print("LDAP Client uninstallation bypassed")
            line = "LDAP Client uninstallation bypassed"
            log_changes(line, "services")
    else:
        print("LDAP Client is not installed")
        line = "LDAP Client is not installed"
        log_changes(line, "services")
...
def purge_rpcbind():
    if check_rpcbind():
        if ask("RPC Client"):
            print(f"\033[91mUninstallation of RPC-Client...\033[0m")
            line = "\033[91mUninstallation of RPC-Client...\033[0m"
            log_changes(line, "services")
            os.system("apt purge rpcbind > /dev/null 2>&1")
        else:
            print("RPC Client uninstallation bypassed")
            line = "RPC Client uninstallation bypassed"
            log_changes(line, "services")
    else:
        print("RPC Client is not installed")
        line = "RPC Client is not installed"
        log_changes(line, "services")
...
#             line = "Telnet Client is uninstalled...{Style.RESET_ALL}\n"
#             log_changes(line, "services")
#             os.system("apt purge telnet > /dev/null 2>&1")
#         else:
...
#             line = "LDAP client is uninstalled\n"
#             log_changes(line, "services")
#             os.system("apt purge ldap-utils > /dev/null 2>&1")
#         else:
...
#             line = "RPC Client is uninstalled..\n"
#             log_changes(line, "services")
#             os.system("apt purge rpcbind > /dev/null 2>&1")
#         else:
#             print("RPC Client not removed due to user input.\n")
#             line = "RPC Client wasnt removed by the user.\n"
#             log_changes(line, "services")
#     else:
